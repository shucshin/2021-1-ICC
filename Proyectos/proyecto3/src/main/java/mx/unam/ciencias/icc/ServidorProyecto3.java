...
/**
 * ServidorProyecto3: Parte del servidor para el proyecto 3
 */
public class ServidorProyecto3 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ServidorBaseDeDatosComputadoras servidor;
            servidor = new ServidorBaseDeDatosComputadoras(puerto, archivo);
