...
public class TestConexion {
    ...
    @Test public void testRecibeMensajes() {
        ...
        try {
            ...
            Conexion<Computadora> conexion =
                new Conexion<Computadora>(bdd, enchufe);
    ...
    @Test public void testRecibeRegistro() {
        try {
            ...
            Computadora e = TestComputadora.computadoraAleatorio(100);
            out.write(e.serializa());
            out.flush();
            UtilRed.espera(10);

            Computadora f = conexion.recibeRegistro();
