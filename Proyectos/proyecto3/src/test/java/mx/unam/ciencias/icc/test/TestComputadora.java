...
public class TestComputadora {
    ...
    /**
     * Prueba unitaria para {@link Computadora#compañiaProperty}.
     */
    @Test public void testCompañiaProperty() {
        String compañia = compañiaAleatorio();
        int memoria = memoriaAleatorio();
        double discoDuro = discoDuroAleatorio();
        int costo = costoAleatorio();
        String sistema = sistemaAleatorio();
        computadora = new Computadora(compañia, memoria, discoDuro, costo, sistema);
        Assert.assertTrue(computadora.compañiaProperty().get().equals(compañia));
    }
    ...
    /**
     * Prueba unitaria para {@link Computadora#memoriaProperty}.
     */
    @Test public void testMemoriaProperty() {
        String compañia = compañiaAleatorio();
        int memoria = memoriaAleatorio();
        double discoDuro = discoDuroAleatorio();
        int costo = costoAleatorio();
        String sistema = sistemaAleatorio();
        computadora = new Computadora(compañia, memoria, discoDuro, costo, sistema);
        Assert.assertTrue(computadora.memoriaProperty().get() == memoria);
    }
    ...
    /**
     * Prueba unitaria para {@link Computadora#discoDuroProperty}.
     */
    @Test public void testDiscoDuroProperty() {
        String compañia = compañiaAleatorio();
        int memoria = memoriaAleatorio();
        double discoDuro = discoDuroAleatorio();
        int costo = costoAleatorio();
        String sistema = sistemaAleatorio();
        computadora = new Computadora(compañia, memoria, discoDuro, costo, sistema);
        Assert.assertTrue(computadora.discoDuroProperty().get() == discoDuro);
    }
    ...
    /**
     * Prueba unitaria para {@link Computadora#costoProperty}.
     */
    @Test public void testCostoProperty() {
        String compañia = compañiaAleatorio();
        int memoria = memoriaAleatorio();
        double discoDuro = discoDuroAleatorio();
        int costo = costoAleatorio();
        String sistema = sistemaAleatorio();
        computadora = new Computadora(compañia, memoria, discoDuro, costo, sistema);
        Assert.assertTrue(computadora.costoProperty().get() == costo);
    }
    ...
    /**
     * Prueba unitaria para {@link Computadora#sistemaProperty}.
     */
    @Test public void testSistemaProperty() {
        String compañia = compañiaAleatorio();
        int memoria = memoriaAleatorio();
        double discoDuro = discoDuroAleatorio();
        int costo = costoAleatorio();
    ...
    @Test public void testActualiza() {
        ...
        Assert.assertFalse(computadora.compañiaProperty() ==
                           e.compañiaProperty());
        Assert.assertFalse(computadora.memoriaProperty() ==
                           e.memoriaProperty());
        Assert.assertFalse(computadora.discoDuroProperty() ==
                           e.discoDuroProperty());
        Assert.assertFalse(computadora.costoProperty() ==
                           e.costoProperty());
        Assert.assertFalse(computadora.sistemaProperty() ==
                           e.sistemaProperty());
        try {
