...
public class TestEstudiante {
    ...
    /**
     * Prueba unitaria para {@link Estudiante#nombreProperty}.
     */
    @Test public void testNombreProperty() {
        ...
        int edad = edadAleatoria();
        estudiante = new Estudiante(nombre, cuenta, promedio, edad);
        Assert.assertTrue(estudiante.nombreProperty().get().equals(nombre));
    }
    ...
    /**
     * Prueba unitaria para {@link Estudiante#cuentaProperty}.
     */
    @Test public void testCuentaProperty() {
        String nombre = nombreAleatorio();
        int cuenta = cuentaAleatoria();
        double promedio = promedioAleatorio();
        int edad = edadAleatoria();
        estudiante = new Estudiante(nombre, cuenta, promedio, edad);
        Assert.assertTrue(estudiante.cuentaProperty().get() == cuenta);
    }
    ...
    /**
     * Prueba unitaria para {@link Estudiante#promedioProperty}.
     */
    @Test public void testPromedioProperty() {
        String nombre = nombreAleatorio();
        int cuenta = cuentaAleatoria();
        double promedio = promedioAleatorio();
        int edad = edadAleatoria();
        estudiante = new Estudiante(nombre, cuenta, promedio, edad);
        Assert.assertTrue(estudiante.promedioProperty().get() == promedio);
    }
    ...
    /**
     * Prueba unitaria para {@link Estudiante#edadProperty}.
     */
    @Test public void testEdadProperty() {
        ...
        int edad = edadAleatoria();
        estudiante = new Estudiante(nombre, cuenta, promedio, edad);
        Assert.assertTrue(estudiante.edadProperty().get() == edad);
    }
    ...
    /**
     * Prueba unitaria para {@link Estudiante#serializa}.
     */
    @Test public void testSerializa() {
        ...
        String linea = String.format("%s\t%d\t%2.2f\t%d\n",
                                     nombre, cuenta, promedio, edad);
        Assert.assertTrue(estudiante.serializa().equals(linea));
    }

    /**
     * Prueba unitaria para {@link Estudiante#deserializa}.
     */
    ...
    @Test public void testActualiza() {
        ...
        Assert.assertFalse(estudiante.nombreProperty() ==
                           e.nombreProperty());
        Assert.assertFalse(estudiante.cuentaProperty() ==
                           e.cuentaProperty());
        Assert.assertFalse(estudiante.promedioProperty() ==
                           e.promedioProperty());
        Assert.assertFalse(estudiante.edadProperty() ==
                           e.edadProperty());
        try {
    ...
    @Test public void testCaza() {
        ...
        Assert.assertFalse(estudiante.caza(CampoEstudiante.NOMBRE, 1000));
