...
public class ControladorInterfazEstudiantes {
    ...
    @FXML private void agregaEstudiante(ActionEvent evento) {
        ...
        try {
            ...
            conexion.enviaRegistro(controlador.getEstudiante());
        } catch (IOException ioe) {
    ...
    @FXML private void eliminaEstudiantes(ActionEvent evento) {
        ...
        for (Estudiante estudiante :
                 controladorTablaEstudiantes.getSeleccion()) {
    ...
    private void manejaBaseDeDatos(Conexion<Estudiante> conexion) {
        try {
    ...
    private void manejaRegistroAlterado(Conexion<Estudiante> conexion,
                                        Mensaje mensaje) {
        Estudiante e;
        try {
    ...
    private void manejaRegistroModificado(Conexion<Estudiante> conexion) {
        Estudiante e1, e2;
        try {
