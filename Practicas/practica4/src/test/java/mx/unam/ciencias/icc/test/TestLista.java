...
public class TestLista {
    ...
    @Test public void testGetLongitud() {
        ...
        for (int i = 0; i < total/2; i++) {
            lista.agregaFinal(Integer.valueOf(random.nextInt(total)));
            Assert.assertTrue(lista.getLongitud() == i + 1);
        }
        for (int i = total/2; i < total; i++) {
            lista.agregaInicio(Integer.valueOf(random.nextInt(total)));
            Assert.assertTrue(lista.getLongitud() == i + 1);
        }
    ...
    @Test public void testAgregaFinal() {
        ...
        validaLista(lista);
        Assert.assertTrue(lista.esVacia());
        lista.agregaFinal(Integer.valueOf(1));
        validaLista(lista);
        Assert.assertTrue(lista.getUltimo().equals(Integer.valueOf(1)));
        lista.agregaInicio(Integer.valueOf(2));
        validaLista(lista);
        Assert.assertFalse(lista.getUltimo().equals(Integer.valueOf(2)));
        for (int i = 0; i < total; i++) {
            Integer r = Integer.valueOf(random.nextInt(total));
            lista.agregaFinal(r);
            validaLista(lista);
            Integer o = Integer.valueOf(r.intValue());
    ...
    @Test public void testAgregaInicio() {
        ...
        validaLista(lista);
        Assert.assertTrue(lista.esVacia());
        lista.agregaInicio(Integer.valueOf(1));
        validaLista(lista);
        Assert.assertTrue(lista.getPrimero().equals(Integer.valueOf(1)));
        lista.agregaFinal(Integer.valueOf(2));
        validaLista(lista);
        Assert.assertFalse(lista.getPrimero().equals(Integer.valueOf(2)));
        for (int i = 0; i < total; i++) {
            Integer r = Integer.valueOf(random.nextInt(total));
    ...
    @Test public void testInserta() {
        ...
        for (int i = 0; i < total; i++) {
            otra.agregaInicio(Integer.valueOf(ini + i));
            lista.inserta(-1, Integer.valueOf(ini + i));
            validaLista(lista);
            Assert.assertTrue(lista.equals(otra));
            Assert.assertTrue(lista.getPrimero().equals(Integer.valueOf(ini + i)));
        }
        ...
        for (int i = 0; i < total; i++) {
            otra.agregaInicio(Integer.valueOf(ini + i));
            lista.inserta(0, Integer.valueOf(ini + i));
            validaLista(lista);
            Assert.assertTrue(lista.equals(otra));
            Assert.assertTrue(lista.getPrimero().equals(Integer.valueOf(ini + i)));
        }
        ...
        otra = new Lista();
        for (int i = 0; i < total; i++) {
            otra.agregaFinal(Integer.valueOf(ini + i));
            lista.inserta(lista.getLongitud(), Integer.valueOf(ini + i));
            validaLista(lista);
            Assert.assertTrue(lista.equals(otra));
            Assert.assertTrue(lista.getUltimo().equals(Integer.valueOf(ini + i)));
        }
        for (int i = 0; i < total; i++) {
            lista = new Lista();
            otra = new Lista();
            ...
            for (int j = 0; j < total; j++) {
                Integer e = Integer.valueOf(ini + j);
                otra.agregaFinal(e);
                if (j != i)
                    lista.agregaFinal(e);
                else
    ...
    @Test public void testEliminaPrimero() {
        ...
        for (int i = 0; i < total; i++) {
            a[i] = Integer.valueOf(random.nextInt(total));
        ...
        lista.agregaFinal(n1);
        lista.agregaFinal(n2);
        lista.agregaFinal(n1);
        lista.agregaFinal(n3);
        lista.agregaFinal(n1);
        lista.eliminaPrimero();
        Assert.assertTrue(lista.get(0).equals(n2));
        Assert.assertTrue(lista.get(1).equals(n1));
        Assert.assertTrue(lista.get(2).equals(n3));
        Assert.assertTrue(lista.get(3).equals(n1));
    }
    ...
    @Test public void testEliminaUltimo() {
        ...
        lista.agregaFinal(n1);
        lista.eliminaUltimo();
        Assert.assertTrue(lista.get(0).equals(n1));
        Assert.assertTrue(lista.get(1).equals(n2));
        Assert.assertTrue(lista.get(2).equals(n1));
        Assert.assertTrue(lista.get(3).equals(n3));
    }
    ...
    @Test public void testContiene() {
        ...
        int d = random.nextInt(total);
        Integer m = null;
        Integer n = Integer.valueOf(d - 1);
        for (int i = 0; i < total; i++) {
            lista.agregaFinal(Integer.valueOf(d++));
            if (i == total/2)
                m = Integer.valueOf(d - 1);
        }
        Assert.assertTrue(lista.contiene(m));
        Integer o = Integer.valueOf(m.intValue());
    ...
    @Test public void testLimpia() {
        Integer primero = Integer.valueOf(random.nextInt(total));
        lista.agregaFinal(primero);
        for (int i = 0; i < total; i++)
            lista.agregaFinal(Integer.valueOf(random.nextInt(total)));
        Integer ultimo = Integer.valueOf(random.nextInt(total));
    ...
    @Test public void testIndiceDe() {
        ...
        Integer[] a = new Integer[total];
        for (int i = 0; i < total; i++) {
            a[i] = Integer.valueOf(ini + i);
            lista.agregaFinal(a[i]);
        }
        for (int i = 0; i < total; i ++)
            Assert.assertTrue(i == lista.indiceDe(a[i]));
        Assert.assertTrue(lista.indiceDe(Integer.valueOf(ini - 10)) == -1);
    }
    ...
    @Test public void testEquals() {
        ...
        for (int i = 0; i < total; i++) {
            Integer r = Integer.valueOf(random.nextInt(total));
            lista.agregaFinal(r);
            otra.agregaFinal(Integer.valueOf(r.intValue()));
        }
        Assert.assertTrue(lista.equals(otra));
        Integer u = (Integer)lista.eliminaUltimo();
        Assert.assertFalse(lista.equals(otra));
        lista.agregaFinal(Integer.valueOf(u + 1));
        Assert.assertFalse(lista.equals(otra));
    ...
    @Test public void testGetCabeza() {
        ...
        Assert.assertTrue(lista.getCabeza().get().equals(Integer.valueOf(2)));
        lista.agregaInicio(Integer.valueOf(1));
        Assert.assertTrue(lista.getCabeza() != null);
        Assert.assertTrue(lista.getCabeza().get().equals(Integer.valueOf(1)));
        for (int i = 0; i < total; i++) {
            Integer r = Integer.valueOf(random.nextInt(total));
            lista.agregaInicio(r);
    ...
    @Test public void testGetRabo() {
        ...
        Assert.assertTrue(lista.getCabeza() != null);
        Assert.assertTrue(lista.getRabo() != null);
        Assert.assertTrue(lista.getRabo().get().equals(Integer.valueOf(1)));
        lista.agregaFinal(Integer.valueOf(2));
        Assert.assertTrue(lista.getRabo() != null);
        Assert.assertTrue(lista.getRabo().get().equals(Integer.valueOf(2)));
        for (int i = 0; i < total; i++) {
            Integer r = Integer.valueOf(random.nextInt(total));
            lista.agregaFinal(r);
